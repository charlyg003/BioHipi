package org.hipi.util.niftijio;
...
public class NiftiVolume
{
	...
	public static NiftiVolume readStream(InputStream ip) throws IOException
	{
		NiftiHeader hdr = NiftiHeader.readFromStream(ip);
	...
	public static NiftiVolume readDataInput(DataInput di) throws IOException
	{
		NiftiHeader hdr = NiftiHeader.readFromDataInput(di);
