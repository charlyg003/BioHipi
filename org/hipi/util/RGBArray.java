...
//		private Object blue;
//
//		public RGBValue(Object red, Object green, Object blue) {
//			this.red = red;
//			this.green = green;
//			this.blue = blue;
//		}
//
//		public Object getRed() 	{ return this.red; }
//		public Object getGreen() { return this.green; }
//		public Object getBlue() 	{ return this.blue; }
//
...
//
//	private Object[] data;
//	private RGBValue[][] dataRGB;
//
//	public RGBArray(int width, int height, Object[] data) {
//		this.width = width;
//		this.height = height;
//		this.data = data;
//		this.dataRGB = new RGBValue[width][height];
//		setDataRGB();
//	}
//	
//	public RGBValue[][] getDataRGB() { return dataRGB; }
//	
...
//			dataRGB[row][column] = new RGBValue(data[i], data[i+1], data[i+2]);
//
//			if (column == width-1) {
//				row++;
//				column = 0;
