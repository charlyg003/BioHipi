...
/**
 * Interface for decoding a {@link HipiImageHeader} and {@link HipiImage} from a
...
public interface ImageDecoder {
	 ...
	 * {@link java.io.InputStream}. Optionally extracts image EXIF data, if
	 * available.
	 *
	 * @param inputStream
	 *            input stream containing serialized image data
	 * @param includeExifData
	 *            if true attempts to extract image EXIF data
	 *
	...
	/**
	 * Read and decode header for image accessed through a Java
	 * {@link java.io.InputStream}. Does not attempt to extract image EXIF data.
	 * Default implementation in {@link ImageCodec} calls
	 * {@link ImageDecoder#decodeHeader} with includeExifData parameter set to
	 * false.
	 *
	 * @param inputStream
	 *            input stream containing serialized image data
	 ...
	 * accessed through the {@link HipiImage} object returned by this method.
	 * See default implementation in {@link ImageCodec}.
	 *
	 * @param inputStream
	 *            input stream containing serialized image data
	 * @param imageFactory
