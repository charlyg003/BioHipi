...
import org.hipi.image.io.RdaCodec;
...
public final class CodecManager {
	...
	/**
	 * Find a {@link ImageDecoder} capable of deserializing a {@link HipiImage}
	 * object stored in a specific {@link HipiImageFormat}.
	 *
	 * @param format
	...
	/**
	 * Find a {@link ImageEncoder} capable of serializing a {@link HipiImage} to
	 * a target {@link HipiImageFormat}.
	 *
	 * @param format
