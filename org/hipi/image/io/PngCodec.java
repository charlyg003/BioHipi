 ...
 */
public class PngCodec extends ImageCodec { // implements ImageDecoder,
	// ImageEncoder {
	 ...
	 * 
	 * @param image
	 *            the input {@link HipiImage} to be encoded
	 * @param os
	...
	public void encodeImage(HipiImage image, OutputStream os) throws IllegalArgumentException, IOException {
		...
		if (((RasterImage) image).getColorSpace() != HipiColorSpace.RGB) {
